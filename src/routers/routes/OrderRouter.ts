...
export default class OrderRouter extends ApplicationRouter {
    ...
    public initRoutes() {
        this.getRouter().get('/order/user', async (req: any, res: any, next: any) => {
            try {
        ...
        this.getRouter().get('/order/customer', this.onlyAdminStoreMiddleware, async (req: any, res: any, next: any) => {
            try {
        ...
        this.getRouter().get('/order/address/:addressId', this.onlyAdminStoreMiddleware, async (req: any, res: any, next: any) => {
            try {
        ...
        this.getRouter().get('/order/:basketId', this.checkBasketAccessMiddleware, async (req: any, res: any, next: any) => {
            try {
        ...
        this.getRouter().post('/order/:basketId/paid', this.onlyAdminStoreMiddleware, this.checkBasketAccessMiddleware, async (req: any, res: any, next: any) => {
            try {
                const basketId = String(req.params.basketId);
        ...
        this.getRouter().post('/order/:basketId/delivered', this.onlyAdminStoreMiddleware, this.checkBasketAccessMiddleware, async (req: any, res: any, next: any) => {
            try {
                const basketId = String(req.params.basketId);
