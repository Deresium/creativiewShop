...
export default class BasketParser {
    public static parseBasket(data: any): BasketVM {
        ...
        return new BasketVM(data.basketId, productOptionStores, data.total, data.totalWeight, data.deliveryAddressId, data.billingAddressId, data.deliveryAddressCountryId, data.deliveryOptionId);
    }
