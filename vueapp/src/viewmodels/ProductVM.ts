export default class ProductVM {
    ...
    constructor(productId: string, customerId: number, manufacturerId: string, manufacturerName: string, code: string, nameFr: string, nameEn: string, descriptionFr: string, descriptionEn: string) {
